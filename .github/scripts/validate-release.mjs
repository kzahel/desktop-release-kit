...
export function validateRelease({ release, latest, tag, repository }) {
  ...
  const installerPatterns = [
    [/_[0-9.]+_aarch64\.dmg$/, "macOS Apple-silicon DMG"],
    [/_[0-9.]+_x64\.dmg$/, "macOS Intel DMG"],
    [/_[0-9.]+_x64-setup\.exe$/, "Windows NSIS installer"],
    [/_[0-9.]+_x64(?:_en-US)?\.msi$/, "Windows MSI installer"],
    [/_[0-9.]+_amd64\.AppImage$/, "Linux x86_64 AppImage"],
    [/_[0-9.]+_amd64\.deb$/, "Linux x86_64 DEB"],
    [/-[0-9.]+-1\.x86_64\.rpm$/, "Linux x86_64 RPM"],
    [/_[0-9.]+_aarch64\.AppImage$/, "Linux ARM64 AppImage"],
    [/_[0-9.]+_arm64\.deb$/, "Linux ARM64 DEB"],
